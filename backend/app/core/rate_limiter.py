...
# 全局实例
user_limiter = SlidingWindowLimiter(max_requests=30, window_seconds=60)
ip_limiter = SlidingWindowLimiter(max_requests=100, window_seconds=60)
